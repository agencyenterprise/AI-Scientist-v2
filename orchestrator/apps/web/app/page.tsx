...
export default async function HomePage() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-12 py-8">
      <section
        className="relative overflow-hidden rounded-[2.75rem] border border-slate-800/80 bg-slate-950/40 px-6 py-12 shadow-[0_50px_140px_-60px_rgba(14,165,233,0.9)] sm:px-12 sm:py-16"
      >
