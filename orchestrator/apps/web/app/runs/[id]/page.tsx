...
export default async function RunDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const autoValidation = detail.validations.find((validation) => validation.kind === "auto")
  const humanValidation = detail.validations.find((validation) => validation.kind === "human")
